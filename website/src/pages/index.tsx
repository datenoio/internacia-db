...
export default function Home(): ReactNode {
  return (
    <Layout
      title="Documentation"
      description="Internacia DB documentation: countries, international organizations, query recipes, and agent workflows. Part of the Dateno open-source project.">
      <HomepageHeader />
      <main>
        <DocsContents />
      </main>
