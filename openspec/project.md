...
## Domain Context
- **Countries Dataset**: Reference data for 256 countries and territories. In scope:
...
- **International Blocks Dataset**: Contains 1,071 organizations across 63 categories:
